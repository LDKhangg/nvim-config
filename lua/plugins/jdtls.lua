return {
  ...
  config = function()
    ...
    local project_key = vim.fn.sha256(vim.fn.fnamemodify(root_dir, ":p")):sub(1, 12)
    local workspace_dir = vim.fn.stdpath("cache") .. "/jdtls/workspace/" .. project_name .. "-" .. project_key
    ...
    local config = {
      cmd = {
        ...
        "--add-opens", "java.compiler/com.sun.tools.javac.api=ALL-UNNAMED",
        "--add-opens", "java.compiler/com.sun.tools.javac.code=ALL-UNNAMED",
        "--add-opens", "java.compiler/com.sun.tools.javac.comp=ALL-UNNAMED",
        "--add-opens", "java.compiler/com.sun.tools.javac.file=ALL-UNNAMED",
        "--add-opens", "java.compiler/com.sun.tools.javac.main=ALL-UNNAMED",
        "--add-opens", "java.compiler/com.sun.tools.javac.model=ALL-UNNAMED",
        "--add-opens", "java.compiler/com.sun.tools.javac.parser=ALL-UNNAMED",
        "--add-opens", "java.compiler/com.sun.tools.javac.processing=ALL-UNNAMED",
